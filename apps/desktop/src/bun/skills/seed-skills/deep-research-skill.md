...
Before starting the research, ask the user for clarification on the topic if needed:

1. **Ask the user for clarification**: `ask_user_question` for clarification on the topic.
