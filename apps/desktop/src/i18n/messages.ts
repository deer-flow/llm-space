...
const APP_MESSAGES = {
  en: {
    ...
    memory: {
      title: "Memory",
      description: "Memories the agent saved on this machine, shared by every project.",
      searchPlaceholder: "Search memories",
      project: "Project",
      allProjects: "All projects",
      usage: "{used} of {max} used",
      archived: "{count} archived",
      empty: "No memories yet. They show up here once the agent saves one.",
      noMatch: "No memories match this search.",
      ...
      deleteDescription: "It is removed from local storage. This cannot be undone.",
      editTitle: "Edit memory",
      exportAction: "Export",
      exportTitle: "Export all memories?",
      exportDescription: "Writes an unencrypted JSON file next to the memory store. Review it before sharing.",
      clearArchive: "Clear archive",
      clearArchiveTitle: "Delete the archive?",
      clearArchiveDescription: "Archived memories are removed from this machine for good.",
      save: "Save",
      updated: "Memory updated.",
      deleted: "Memory deleted.",
      exported: "Exported {count} memories.",
      archiveCleared: "Archive cleared ({count} removed).",
  ...
  zh: {
    ...
    memory: {
      title: "记忆",
      description: "保存在本机的记忆，所有项目共享。",
      searchPlaceholder: "搜索记忆",
      project: "项目",
      allProjects: "所有项目",
      usage: "已使用 {used} / {max}",
      archived: "归档 {count} 条",
      empty: "还没有记忆。agent 保存后会出现在这里。",
      noMatch: "没有匹配的记忆。",
      showContent: "显示内容",
      hideContent: "隐藏内容",
      hidden: "已隐藏",
      ...
      delete: "删除",
      deleteTitle: "删除这条记忆？",
      deleteDescription: "它将从本地存储中移除，此操作无法撤销。",
      editTitle: "编辑记忆",
      exportAction: "导出",
      exportTitle: "导出全部记忆？",
      exportDescription: "会在记忆存储旁写入一个未加密的 JSON 文件，分享前请先检查内容。",
      clearArchive: "清理归档",
      clearArchiveTitle: "删除归档？",
      clearArchiveDescription: "归档的记忆将从本机彻底删除。",
      save: "保存",
      updated: "记忆已更新。",
      deleted: "记忆已删除。",
      exported: "已导出 {count} 条记忆。",
      archiveCleared: "归档已清理（移除 {count} 条）。",
      loadFailed: "无法加载记忆。",
    },
    skills: {
      title: "技能",
