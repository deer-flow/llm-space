...
export const FALLBACK_RELEASES: Releases = {
  stable: {
    version: "v4.15.2",
    appleSilicon: {
      url: `${RELEASES_URL}/download/v4.15.2/LLMSpace-performance-v4.15.2-macos-arm64.dmg`,
      size: 134_382_408,
    },
    intel: {
      url: `${RELEASES_URL}/download/v4.15.2/LLMSpace-performance-v4.15.2-macos-x64.dmg`,
      size: 144_535_209,
    },
  },
};
