...
export const FALLBACK_RELEASES: Releases = {
  stable: {
    version: "v4.8.1",
    appleSilicon: {
      url: `${RELEASES_URL}/download/v4.8.1/LLMSpace-performance-v4.8.1-macos-arm64.dmg`,
      size: 133_603_273,
    },
    intel: {
      url: `${RELEASES_URL}/download/v4.8.1/LLMSpace-performance-v4.8.1-macos-x64.dmg`,
      size: 143_754_030,
    },
  },
};
