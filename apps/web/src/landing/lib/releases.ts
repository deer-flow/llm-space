...
export const FALLBACK_RELEASES: Releases = {
  stable: {
    version: "v4.15.0",
    appleSilicon: {
      url: `${RELEASES_URL}/download/v4.15.0/LLMSpace-performance-v4.15.0-macos-arm64.dmg`,
      size: 133_777_203,
    },
    intel: {
      url: `${RELEASES_URL}/download/v4.15.0/LLMSpace-performance-v4.15.0-macos-x64.dmg`,
      size: 143_800_568,
    },
  },
};
