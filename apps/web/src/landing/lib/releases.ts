...
export const FALLBACK_RELEASES: Releases = {
  stable: {
    version: "v4.15.1",
    appleSilicon: {
      url: `${RELEASES_URL}/download/v4.15.1/LLMSpace-performance-v4.15.1-macos-arm64.dmg`,
      size: 134_071_029,
    },
    intel: {
      url: `${RELEASES_URL}/download/v4.15.1/LLMSpace-performance-v4.15.1-macos-x64.dmg`,
      size: 143_798_742,
    },
  },
};
