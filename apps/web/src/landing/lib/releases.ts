...
export const FALLBACK_RELEASES: Releases = {
  stable: {
    version: "v4.11.0",
    appleSilicon: {
      url: `${RELEASES_URL}/download/v4.11.0/LLMSpace-performance-v4.11.0-macos-arm64.dmg`,
      size: 134_014_147,
    },
    intel: {
      url: `${RELEASES_URL}/download/v4.11.0/LLMSpace-performance-v4.11.0-macos-x64.dmg`,
      size: 144_542_235,
    },
  },
};
