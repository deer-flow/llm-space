...
export const FALLBACK_RELEASES: Releases = {
  stable: {
    version: "v4.8.5",
    appleSilicon: {
      url: `${RELEASES_URL}/download/v4.8.5/LLMSpace-performance-v4.8.5-macos-arm64.dmg`,
      size: 134_010_145,
    },
    intel: {
      url: `${RELEASES_URL}/download/v4.8.5/LLMSpace-performance-v4.8.5-macos-x64.dmg`,
      size: 143_598_330,
    },
  },
};
