...
export const FALLBACK_RELEASES: Releases = {
  stable: {
    version: "v4.16.0",
    appleSilicon: {
      url: `${RELEASES_URL}/download/v4.16.0/LLMSpace-performance-v4.16.0-macos-arm64.dmg`,
      size: 134_009_398,
    },
    intel: {
      url: `${RELEASES_URL}/download/v4.16.0/LLMSpace-performance-v4.16.0-macos-x64.dmg`,
      size: 143_815_256,
    },
  },
};
