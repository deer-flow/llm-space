...
export const FALLBACK_RELEASES: Releases = {
  stable: {
    version: "v4.12.1",
    appleSilicon: {
      url: `${RELEASES_URL}/download/v4.12.1/LLMSpace-performance-v4.12.1-macos-arm64.dmg`,
      size: 134_014_028,
    },
    intel: {
      url: `${RELEASES_URL}/download/v4.12.1/LLMSpace-performance-v4.12.1-macos-x64.dmg`,
      size: 144_543_807,
    },
  },
};
