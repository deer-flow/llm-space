...
export const FALLBACK_RELEASES: Releases = {
  stable: {
    version: "v4.10.0",
    appleSilicon: {
      url: `${RELEASES_URL}/download/v4.10.0/LLMSpace-performance-v4.10.0-macos-arm64.dmg`,
      size: 132_930_833,
    },
    intel: {
      url: `${RELEASES_URL}/download/v4.10.0/LLMSpace-performance-v4.10.0-macos-x64.dmg`,
      size: 143_085_959,
    },
  },
};
