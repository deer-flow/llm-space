...
export const FALLBACK_RELEASES: Releases = {
  stable: {
    version: "v4.12.2",
    appleSilicon: {
      url: `${RELEASES_URL}/download/v4.12.2/LLMSpace-performance-v4.12.2-macos-arm64.dmg`,
      size: 134_012_903,
    },
    intel: {
      url: `${RELEASES_URL}/download/v4.12.2/LLMSpace-performance-v4.12.2-macos-x64.dmg`,
      size: 143_806_049,
    },
  },
};
