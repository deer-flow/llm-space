...
export const FALLBACK_RELEASES: Releases = {
  stable: {
    version: "v4.18.0",
    appleSilicon: {
      url: `${RELEASES_URL}/download/v4.18.0/LLMSpace-performance-v4.18.0-macos-arm64.dmg`,
      size: 134_062_516,
    },
    intel: {
      url: `${RELEASES_URL}/download/v4.18.0/LLMSpace-performance-v4.18.0-macos-x64.dmg`,
      size: 144_689_333,
    },
  },
};
