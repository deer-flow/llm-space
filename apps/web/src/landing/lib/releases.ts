...
export const FALLBACK_RELEASES: Releases = {
  stable: {
    version: "v4.12.0",
    appleSilicon: {
      url: `${RELEASES_URL}/download/v4.12.0/LLMSpace-performance-v4.12.0-macos-arm64.dmg`,
      size: 133_781_789,
    },
    intel: {
      url: `${RELEASES_URL}/download/v4.12.0/LLMSpace-performance-v4.12.0-macos-x64.dmg`,
      size: 145_567_155,
    },
  },
};
