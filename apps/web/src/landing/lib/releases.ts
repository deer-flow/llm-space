...
export const FALLBACK_RELEASES: Releases = {
  stable: {
    version: "v4.14.2",
    appleSilicon: {
      url: `${RELEASES_URL}/download/v4.14.2/LLMSpace-performance-v4.14.2-macos-arm64.dmg`,
      size: 134_377_127,
    },
    intel: {
      url: `${RELEASES_URL}/download/v4.14.2/LLMSpace-performance-v4.14.2-macos-x64.dmg`,
      size: 144_091_747,
    },
  },
};
