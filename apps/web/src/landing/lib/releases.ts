...
export const FALLBACK_RELEASES: Releases = {
  stable: {
    version: "v4.13.0",
    appleSilicon: {
      url: `${RELEASES_URL}/download/v4.13.0/LLMSpace-performance-v4.13.0-macos-arm64.dmg`,
      size: 133_782_090,
    },
    intel: {
      url: `${RELEASES_URL}/download/v4.13.0/LLMSpace-performance-v4.13.0-macos-x64.dmg`,
      size: 144_543_981,
    },
  },
};
