...
export const FALLBACK_RELEASES: Releases = {
  stable: {
    version: "v4.14.0",
    appleSilicon: {
      url: `${RELEASES_URL}/download/v4.14.0/LLMSpace-performance-v4.14.0-macos-arm64.dmg`,
      size: 134_012_533,
    },
    intel: {
      url: `${RELEASES_URL}/download/v4.14.0/LLMSpace-performance-v4.14.0-macos-x64.dmg`,
      size: 144_527_704,
    },
  },
};
